...
# Figure 06_01 #
################
#png("./Data files/4367OS_06_01.png",width=5.5,height=3.45,units="in",res=300,pointsize=10)
plot(dem)
...
# Figure 06_02 #
################
#png("./Data files/4367OS_06_02.png",width=5.0,height=5.5,units="in",res=300)
plot(dem)
dev.off()
...
# Figure 06_03 #
################
#png("./Data files/4367OS_06_03.png",width=5.5,height=2.0,units="in",res=300,pointsize=10)
...
# Figure 06_04 #
################
#png("./Data files/4367OS_06_04.png",width=5.5,height=3.0,units="in",res=300,pointsize=10)
...
# Figure 06_05 #
################
#png("./Data files/4367OS_06_05.png",width=5.5,height=3.0,units="in",res=300,pointsize=10)
par(mfrow=c(1,2), mai = rep(0.75, 4))
...
# Figure 06_06 #
################
#png("./Data files/4367OS_06_06.png",width=5.5,height=3.5,units="in",res=300)
library(rasterVis)
...
# Figure 06_07 #
################
#png("./Data files/4367OS_06_07.png",width=5.0,height=5.5,units="in",res=300)
plot(dem)
dev.off()
...
# Figure 06_08 #
################
#png("./Data files/4367OS_06_08.png",width=5.5,height=2.0,units="in",res=300,pointsize=10)
par(mfrow = c(1,3), mai = rep(0.5, 4))
...
# Figure 06_09 #
################
#png("./Data files/4367OS_06_09.png",width=5.5,height=2.5,units="in",res=300,pointsize=10)
...
# Figure 06_10 #
################
#png("./Data files/4367OS_06_10.png",width=5.5,height=5.5,units="in",res=300)
...
# Figure 06_11 #
################
#png("./Data files/4367OS_06_11.png",width=5.5,height=5.5,units="in",res=300)
...
# Figure 06_12 #
################
#png("./Data files/4367OS_06_12.png",width=5.5,height=4.5,units="in",res=300)
...
# Figure 06_14 #
################
#png("./Data files/4367OS_06_14.png",width=5.5,height=2.5,units="in",res=300)
levelplot(s,
	par.settings = RdBuTheme,
	contour = TRUE,
	margin = FALSE,
