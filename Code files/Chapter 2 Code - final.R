...
# Figure 02_02 #
################
png("./Data files/4367OS_02_02.png",width=5.5,height=5.5,units="in",res=300)
plot(tmax)
dev.off()
...
# Figure 02_03 #
################
png("./Data files/4367OS_02_03.png",width=5.5,height=4,units="in",res=300)
plot(time, tmax, type = "l")
dev.off()

plot(tmax ~ time, type = "l")

pdf("./Data files/time_series.pdf")
plot(tmax ~ time, type = "l")
dev.off()
