...
### From Chapter 2
dat = read.csv("./Data files/338284.csv", stringsAsFactors = FALSE)
time = dat$DATE
tmax = dat$TMAX
...
# Figure 09_01 #
################
ggsave("./Data files/4367OS_09_01.png", width = 5.5, height = 3.5)
...
# Figure 09_02 #
################
ggsave("./Data files/4367OS_09_02.png", width = 5.5, height = 3.5)
...
ggsave(plot = tmax_line,
	filename = "./Data files/4367OS_09_01.png",
	width = 5.5,
	height = 3.5)
...
# Figure 09_05 #
################
ggsave("./Data files/4367OS_09_05.png", width = 5.5, height = 3.25)
...
# Figure 09_06 #
################
ggsave("./Data files/4367OS_09_06.png", width = 5.5, height = 3.25)
...
# Figure 09_08 #
################
ggsave("./Data files/4367OS_09_08.png", width = 4.5, height = 5.5)
...
# Figure 09_09 #
################
ggsave("./Data files/4367OS_09_09.png", width = 5.5, height = 5.0)
...
# Figure 09_10 #
################
ggsave("./Data files/4367OS_09_10.png", width = 6.5, height = 3)
...
# Figure 09_11 #
################
ggsave("./Data files/4367OS_09_11.png", width = 5.5, height = 4.75)
...
# Figure 09_12 #
################
ggsave("./Data files/4367OS_09_12.png", width = 5.5, height = 4.75)
...
# Figure 09_13 #
################
#png("./Data files/4367OS_09_13.png",width=5.5,height=5.5,units="in",res=300)
wireframe(z ~ x * y,
	data = dem_df,
	drape = TRUE,
	colorkey = TRUE,
...
# Figure 09_14 #
################
#png("./Data files/4367OS_09_14.png",width=5.5,height=3,units="in",res=300)
